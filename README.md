...
|  Gestión de locales y experiencia social: <br> Como dueño de un restaurante o usuario activo, quiero que la plataforma permita mostrar mi local, recibir reseñas y destacar mi presencia en el mapa, para aumentar la visibilidad y mejorar la experiencia de comunidad. | EP03 |
|                         |          |
|                         |          |
|                         |          |
|                         |          |
...
| **US07**       | Iniciar sesión o registrarse | Como nuevo usuario, quiero crear una cuenta o iniciar sesión con mis credenciales, para acceder a mis contactos, cálculos y preferencias. | **Escenario 1:** Dado que soy nuevo, **cuando** registro mi correo y contraseña, **entonces** se crea mi cuenta.<br>**Escenario 2:** Dado que ya tengo cuenta, **cuando** inicio sesión correctamente, **entonces** accedo a mi perfil. | EP01 |
| **US08**       | Ver listado de restaurantes disponibles | Como usuario, quiero visualizar una lista de restaurantes recomendados según la ubicación del grupo, para elegir el más conveniente. | **Escenario 1:** Dado que el grupo está definido, **cuando** accedo a “Restaurantes”, **entonces** se muestran las opciones con distancia y valoración. | EP02 |
| **US09**       | Recibir notificaciones de grupo | Como usuario, quiero recibir notificaciones cuando mi grupo confirme un punto de encuentro, para mantenerme informado. | **Escenario 1:** Dado que pertenezco a un grupo, **cuando** el organizador confirma el punto medio, **entonces** recibo una alerta en mi panel. | EP01 |
| **US10**       | Calificar restaurantes visitados | Como usuario, quiero poder calificar los restaurantes visitados después de una reunión, para aportar mi opinión a otros. | **Escenario 1:** Dado que asistí a un restaurante, **cuando** termino la visita, **entonces** puedo dejar una reseña con estrellas y comentarios. | EP03 |
| **US11**       | Registrar y editar perfil de restaurante | Como dueño de local, quiero registrar mi negocio con sus datos, horarios y tipo de comida, para hacerlo visible a los usuarios. | **Escenario 1:** Dado que soy propietario, **cuando** completo el formulario con datos del local, **entonces** aparece en el mapa de LocalFood.<br>**Escenario 2:** Dado que ya estoy registrado, **cuando** edito los datos, **entonces** se actualiza su información en tiempo real. | EP03 |
| **US12**       | Activar modo visual o idioma | Como usuario, quiero cambiar el idioma o el tema visual (claro/oscuro) para usar la aplicación de forma cómoda. | **Escenario 1:** Dado que estoy en “Configuración”, **cuando** selecciono un idioma distinto, **entonces** la interfaz se traduce.<br>**Escenario 2:** Dado que prefiero modo oscuro, **cuando** lo activo, **entonces** toda la interfaz se adapta visualmente. | EP01 |
## 3.3. Impact Mapping.
